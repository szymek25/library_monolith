...
<t:page title="categories.edit.title">

  <form:form modelAttribute="editCategoryForm" method="POST">
    <div class="form-row">
      <h1>
        <spring:message code="categories.edit.form.title"/>
      </h1>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputName">
          <spring:message code="categories.edit.form.name"/>
        </label>
      ...
      <div class="form-group col-md-6">
        <label for="inputDaysOfRent">
          <spring:message code="categories.edit.form.daysOfRent"/>
        </label>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputProlongation">
          <spring:message code="categories.edit.form.continuationPossible"/>
        </label>
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit">
      <spring:message code="categories.edit.form.submit"/>
    </button>
  </form:form>
