...
<t:page title="users.edit.title">

  <form:form modelAttribute="editUserForm" method="POST">
    <div class="form-row">
      <h1>
        <spring:message code="users.edit.form.title"/>
      </h1>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputEmail">
          <spring:message code="users.edit.form.email"/>
        </label>
        <form:input type="email" path="email" class="form-control" id="inputEmail"/>
        <form:errors path="email" cssClass="error"/>
      </div>
      <div class="form-group col-md-6 <sec:authorize access="hasRole('EMPLOYEE')">display-none</sec:authorize>">
        <label for="inputRole">
          <spring:message code="users.edit.form.role"/>
        </label>
    ...
    <div class="form-row">
      <div class="form-group col-md-4">
        <label for="inputName">
          <spring:message code="users.edit.form.name"/>
        </label>
      ...
      <div class="form-group col-md-4">
        <label for="lastNameInput">
          <spring:message code="users.edit.form.lastName"/>
        </label>
      ...
      <div class="form-group col-md-4">
        <label for="dayOfBirthInput">
          <spring:message code="users.edit.form.dayOfBirth"/>
        </label>
    ...
    <div class="form-row">
      <div class="form-group col-md-4">
        <label for="inputAddressLine1">
          <spring:message code="users.edit.form.addressLine1"/>
        </label>
      ...
      <div class="form-group col-md-4">
        <label for="townInput">
          <spring:message code="users.edit.form.town"/>
        </label>
      ...
      <div class="form-group col-md-4">
        <label for="postalCodeInput">
          <spring:message code="users.edit.form.postalCode"/>
        </label>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="phoneInput">
          <spring:message code="users.edit.form.phone"/>
        </label>
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit">
      <spring:message code="users.edit.form.submit"/>
    </button>
  </form:form>

  <form:form modelAttribute="updatePasswordForm" action="/users/edit/${userId}/updatePassword" method="POST">
    <div class="form-row">
      <h1>
        <spring:message code="users.edit.updatepass.form.title"/>
      </h1>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputPassword">
          <spring:message code="users.edit.updatepass.form.password"/>
        </label>
      ...
      <div class="form-group col-md-6">
        <label for="inputConfirmPassword">
          <spring:message code="users.edit.updatepass.form.confirmPassword"/>
        </label>
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit">
      <spring:message code="users.edit.updatepass.form.submit"/>
    </button>
  </form:form>
